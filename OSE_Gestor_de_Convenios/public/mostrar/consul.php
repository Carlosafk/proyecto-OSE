...
<body>
 <center><img src="ittg.jpg"width="780px" height="90px"/></center>
        ...
        <div class="flexsearch--wrapper">
            <form class="flexsearch--form" action="busc.php" method="POST">
                <div class="flexsearch--input-wrapper">
                    <input class="flexsearch--input" type="search" name="bus" placeholder="Buscar carrera">
                </div>
                <input class="flexsearch--submit" type="submit" name="busc" value="&#10140;"/>
            </form>
        </div>
</div>
          ...
          /*     $sql="SELECT carrera,convenio_convenio_tipo,convenio_empresa_empresa_nom FROM escuela";
               $res=mysqli_query($conn,$sql) or die ("error al consultar");
                     while(($r=mysqli_fetch_array($res, MYSQLI_ASSOC))){
                    $empre=$r['convenio_empresa_empresa_nom'];
                    $conv=$r['convenio_convenio_tipo'];
                    $carr=$r['carrera'];*/

 echo "<div class=div-table-row style='width:910px; height=160px; overflow:auto'>";
